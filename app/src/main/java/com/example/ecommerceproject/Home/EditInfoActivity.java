...
public class EditInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingstoolbar.setTitle("Edit Info");
        ...
        profileChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if (ActivityCompat.checkSelfPermission(EditInfoActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED)
                {
                    Toast.makeText(EditInfoActivity.this,"Please grant the permission.", Toast.LENGTH_SHORT).show();
                    requestPermission();
                }else
                {
                    checker = "clicked";
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(EditInfoActivity.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        else
        {
            ...
            startActivity(new Intent(EditInfoActivity.this, EditInfoActivity.class));
            finish();
        }
    }
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(EditInfoActivity.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
