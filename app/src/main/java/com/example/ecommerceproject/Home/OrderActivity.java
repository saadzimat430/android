...
import com.example.ecommerceproject.Home.Adapters.OrderAdapter;
...
public class OrderActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("orders").child(user_id).child("products").addChildEventListener(new ChildEventListener() {
            @Override
