...
public class MapsActivity extends FragmentActivity
{
    ...
    private String compnany_address ="";
    Marker marker;
    Toolbar cToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cToolbar = findViewById(R.id.toolbarMp);
        cToolbar.setTitle("Company Map");
        ...
        compnany_address = bundle.get("company_add").toString();
    }
        ...
        if (mMap == null) {
            ...
            mapFragment.getMapAsync(new OnMapReadyCallback() {
                                        ...
                                        public void onMapReady(GoogleMap googleMap) {
                                            ...
                                            try {
                                                list = gc.getFromLocationName(compnany_address + "  ,maroc", 1);
                                            } catch (IOException e) {
                                                e.printStackTrace();
                                            }
